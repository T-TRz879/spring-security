 ...
 * <p>
 * The {@code FilterChainProxy} is linked into the servlet container filter chain by adding a standard Spring
 * {@link DelegatingFilterProxy} declaration in the application {@code web.xml} file.
 *
 * <h2>Configuration</h2>
 * <p>
 ...
 * <p>
 * {@code FilterChainProxy} respects normal handling of {@code Filter}s that elect not to call
 * {@link javax.servlet.Filter#doFilter(javax.servlet.ServletRequest, javax.servlet.ServletResponse,
...
public class FilterChainProxy extends GenericFilterBean {
	...
	private void doFilterInternal(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// 使用虚拟的过滤器链帮助我们调用securityFilterChain
